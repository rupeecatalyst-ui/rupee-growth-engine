...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "apple-mobile-web-app-title", content: "Rupee Catalyst" },
      { name: "mobile-web-app-capable", content: "yes" },
      { title: "Rupee Catalyst — Loans & Mutual Fund Investments" },
      {
        name: "description",
        content:
          "Home Loans, Personal Loans, Business Loans, Loan Against Property, Balance Transfer and Mutual Fund Investments — with 100+ lending partners and 20+ years of experience.",
      },
      { name: "author", content: "Rupee Catalyst" },
      { property: "og:site_name", content: "Rupee Catalyst" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          name: "Rupee Catalyst",
          description:
            "Loans and Mutual Fund investments with 100+ lending partners and 20+ years of experience.",
          areaServed: "IN",
        }),
      },
    ],
